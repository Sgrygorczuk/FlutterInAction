...
/*
This data holds data about counties
 */

class Country {
  //================ Variables =================================================
  final String dialingCode; //Phone Number Code
  final String isoCode;    //Name of country and subdivision
  ...
  //============== Methods =====================================================
  /*
  Overwrites the == operator to check if the two countrys are equal
   */
  @override
  bool operator ==(o) =>
      o is Country &&
  ...
  */
  ...
  /*
  Creates a copy of the country with modified values
   */
  Country copyWith({String name, String isoCode, String dialingCode,}) {
    return Country(
      //?? if not provided use what the current info is
      name: name ?? this.name,
